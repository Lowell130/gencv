<template>
  ...
  <div class="mx-auto max-w-screen-xl text-center">
      ...
      <p class="my-6 text-gray-500 dark:text-gray-400">Crea il tuo CV in pochi minuti.</p>
     
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">genCV™</a>. All Rights Reserved.</span>
...
<!-- Bottone Torna su visibile solo dopo scroll -->
<button
  v-if="showScrollTop"
  @click="scrollToTop"
  class="group fixed bottom-6 right-6 z-50 text-black bg-white border border-black hover:bg-black hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2">
  <svg class="w-6 h-6 text-black group-hover:text-white transition-colors" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
